...
class ReportsView(ctk.CTkFrame):
    ...
    def build_clients_tab(self):
        ...
        ctk.CTkButton(card_gen, text="Exportar Excel Historial", command=self.export_client_excel, fg_color=Colors.SUCCESS).pack(pady=10)
    ...
    def build_products_tab(self):
        ...
        card_cat = self._create_card(frm, "Catálogo Visual", 0, 1)
    ...
    def gen_vendor_catalog(self):
        data = self.controller.get_vendors_list_report()
        cols = ["ID", "Nombre", "Sucursal", "Provincia", "Foto"]
        PrintEngine.generate_catalog_pdf("Catálogo de Vendedores", data, cols, "Catalogo_Vendedores.pdf")
